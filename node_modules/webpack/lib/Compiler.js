...
class Compiler {
	 ...
	 * @returns {void}
	 */
    //! 这个run方法在外部会被compiler实例调用 compiler.run()
	run(callback) {
		if (this.running) {
...
${other}`);
    ...
    // ! compile 编译的意思  它里面包含的就是webpack打包流程
    // !  在这之前,做了命令行参数处理,和compiler的声明
	compile(callback) {
        // ! params创建两个工厂对象
		...
		this.hooks.beforeCompile.callAsync(params, err => {
            ...
            // ! 在 beforeCompile 中声明了一个 compilation
